<?php
	...
	if($shop_style == 'grid3cols' || $shop_style == 'grid3cols_rightsidebar' || $shop_style == 'grid3cols_leftsidebar') {
		$class_holder = 'side';
	} elseif ($shop_style == 'grid4cols_rightsidebar' || $shop_style == 'grid4cols_leftsidebar') {
		$class_holder = 'sidebar';
	} else $class_holder = '';
	...
	<?php if ($page['content']): ?>
		...
		<div class="row products-shop">
			...
			<div class="col-xs-12">
				...
				<div class="products-holder <?php  print $class_holder; ?>">
