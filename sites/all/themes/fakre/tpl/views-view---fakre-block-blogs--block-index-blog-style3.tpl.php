		...
		?>
			...
			<?php elseif ($post_format == 'fa-file-audio-o' && !empty($node->field_media_upload)): ?>
				...
				<div class="img-box audio-area">
					...
					<img src="<?php print base_path() ?>sites/default/files/demo/inner/img29.jpg" alt="image description" class="img-responsive">
			...
			<?php else: ?>
				...
				<div class="img-box">
					...
					<a href="<?php print $node_url; ?>"><img src="<?php print base_path().path_to_theme(); ?>/images/noimage.jpg" alt="<?php print $title; ?>" class="img-responsive"></a>
			...
			<?php endif; ?>
				...
				<div class="blog-txt">
					...
					<a href="<?php print $node_url; ?>" class="more">[ <?php print 'CONTINUE READING'; ?> ]</a>
